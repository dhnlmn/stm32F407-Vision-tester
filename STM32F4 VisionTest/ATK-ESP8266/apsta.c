...
//	delay_ms(1000);
	...
	while(atk_8266_send_cmd("AT+CIFSR","APIP",20));   //检a't测是否获得AP IP
...
//		LCD_Fill(15+54,95,120,110,WHITE);
		...
		printf("连接成功\r\n");//连接状态
//		Show_Str(15+54,95,200,12,"连接成功",12,0);  //连接状态
		else 
//			Show_Str(15+54,95,200,12,"连接失败",12,0); 	
        printf("连接失败\r\n");		
		t=0;
	}
	if((t%20)==0)LED0=!LED0;
