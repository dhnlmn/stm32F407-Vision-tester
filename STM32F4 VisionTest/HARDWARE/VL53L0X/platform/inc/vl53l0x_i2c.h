...
//IO方向设置
#define VL_SDA_IN()  {GPIOB->MODER&=~(3<<(6*2));GPIOB->MODER|=0<<6*2;}	//PB10输入模式
#define VL_SDA_OUT() {GPIOB->MODER&=~(3<<(6*2));GPIOB->MODER|=1<<6*2;}    //PB10输出模式


//IO操作函数	 
#define VL_IIC_SCL    PBout(7) 		//SCL
